...
def run_single_batch(config):
    ...
    try:
        ...
        thin_data = np.load("kde_grid_thin.npz")
        thick_data = np.load("kde_grid_thick.npz")
        halo_data = np.load("kde_grid_halo.npz")
        ...
        total_objects, total_objects_generated = gen_inactive.generate(
        ...
        # for debugging potential zero generated object cases
            ...
            with open("empty_batches.log", "a") as empty_log:
                ...
                empty_log.write(f"Parameters: Alpha={config['alpha']}, Albedo={config['albedo']}\n")
...
def summarize(config, temp_dir, batch_dir_name, total_objects, total_objects_generated, batch_runtime):
    ...
    with open(summary_path, 'w') as f:
        ...
        f.write(f"Albedo: {config['albedo']}\n")
